...
class ArrowheadClientSync(ArrowheadClient):
    ...
    def consume_service_raw(
        ...
        raw_service = Service(serviceObj.service_definition,
                              ...
                              rule._consumed_service.access_policy,
                              rule._consumed_service.metadata,
                              rule._consumed_service.version)
        
        orchestration_rule = OrchestrationRule(raw_service, 
                                               rule._provider_system, 
                                               serviceObj.method, 
                                               rule._authorization_token)
        
        return self.consumer.consume_service(orchestration_rule, **kwargs, )
