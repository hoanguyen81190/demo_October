...
class CoreServices(CoreConfig, Enum):
    ...
    HISTORIAN = (
        ...
        'GET', 'HTTP', 'JSON',
        constants.CoreSystem.DATA_MANAGER.value,
    )
    PROXY = (
        'proxy',
        'datamanager/proxy',
    ...
    def HISTORIAN_PUT_DATA(systemName, serviceName):
        return CoreConfig(
                    'historian',
                    f'datamanager/historian/{systemName}/{serviceName}',
                    'PUT', 'HTTP', 'JSON',
                    constants.CoreSystem.DATA_MANAGER.value,
                )
        
    def HISTORIAN_FETCH_DATA(systemName, serviceName):
        return CoreConfig(
                    'historian',
                    f'datamanager/historian/{systemName}/{serviceName}',
                    'GET', 'HTTP', 'JSON',
    ...
    def PROXY_PUT_DATA(systemName, serviceName):
        return CoreConfig(
                    'proxy',
                    f'datamanager/proxy/{systemName}/{serviceName}',
                    'PUT', 'HTTP', 'JSON',
                    constants.CoreSystem.DATA_MANAGER.value,
                )
        
    def PROXY_FETCH_DATA(systemName, serviceName):
        return CoreConfig(
                    'proxy',
                    f'datamanager/proxy/{systemName}/{serviceName}',
                    'GET', 'HTTP', 'JSON',
