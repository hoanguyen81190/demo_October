...
class OrchestrationFlagsForm(DTOMixin):
    ...
    enable_inter_cloud: bool = True
    trigger_inter_cloud: bool = True
...
class DataForm(DTOMixin):
    ...
    def make(
        ...
        return json.dumps([baseData.dto(), sensorData.dto()])
    ...
    @classmethod 
    def from_dto(cls, system_dto):
        return cls(
            baseData=system_dto[0],
            sensorData=system_dto[1]
            )